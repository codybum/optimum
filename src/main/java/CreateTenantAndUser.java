...
public class CreateTenantAndUser implements Closeable {
    ...
    public void create() throws IOException {
        ...
        String ident = "http://127.0.0.1:35357/v2.0/";
        String tenantname = "admin2";
        String username = "testuseradmin2";
        String password = "testuser01";

        //CreateTenantAndUser createTenantAndUser = new CreateTenantAndUser(args[0], args[1], args[2], args[3]);
        CreateTenantAndUser createTenantAndUser = new CreateTenantAndUser(ident, tenantname, username, password);
